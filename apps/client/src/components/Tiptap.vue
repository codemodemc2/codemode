<template>
  <div class="form-input-style">
    <div
      v-if="editor"
      class="flex space-x-1 p-1 pb-2 text-sm font-bold text-gray-500"
    >
      <button
        :class="[editor.isActive('bold') ? 'is-active' : '', 'button']"
      ...
      <button
        :class="[editor.isActive('italic') ? 'is-active' : '', 'button']"
      ...
      <button
        :class="[editor.isActive('strike') ? 'is-active' : '', 'button']"
      ...
      <button
        :class="[editor.isActive('code') ? 'is-active' : '', 'button']"
      ...
      <button class="button" @click="editor.chain().focus().undo().run()">
        <svg
          class="w-4 h-4"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
      ...
      <button class="button" @click="editor.chain().focus().redo().run()">
        <svg
          class="w-4 h-4"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
...
<style>
.button {
  @apply text-base font-medium px-1 hover:bg-gray-200 rounded-sm fill-brand-secondary text-brand-secondary;
}
.is-active {
