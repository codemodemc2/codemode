          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <p class="text-xl text-white">Inviting employeess</p>
              </div>
              <DialogTitle as="div" class="flex flex-col leading-6">
                ...
                <p class="text-sm text-gray-500">
                  Invite new employeess to the team.
                </p>
              </DialogTitle>
              <hr class="mt-2" />
...
const inviteEmployees = () => {
  if (users.value.length < 1) return errorToast("Add at least one employee");
  loading.value = true;
  setTimeout(() => {
    loading.value = false;
    successToast("Employees invited!");
    closeModal();
  }, 5000);
};
