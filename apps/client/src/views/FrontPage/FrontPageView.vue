<template>
  <div class="flex flex-col h-screen relative">
    ...
    />
    <div
      class="absolute -left-60 top-60 z-10 h-[50vh] w-[200vw] -rotate-[10deg] transform bg-gradient-to-r from-sky-400 to-sky-600"
    ></div>
...
<script setup>
import NavigationBarVue from "@/components/FrontPage/FrontNavBar.vue";
